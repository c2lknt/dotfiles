...
globalkeys = awful.util.table.join(
    ...
    -- Non-empty tag browsingNon
    awful.key({ altkey, "Control" }, "Tab", function () lain.util.tag_view_nonempty(-1) end),
...
--    awful.key({ altkey, "Shift"   }, "h",      function () awful.tag.incmwfact(-0.05)     end),
    ...
    awful.key({ modkey,           }, "p",      function () os.execute(string.format("~/./flip-screen" )) end),
